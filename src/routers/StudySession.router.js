...
router.get('/:sessionId/consultations/:consultationId/workspace',studySessionController.getConsultationWorkspace,);
router.patch('/:sessionId/consultations/:consultationId/workspace',studySessionController.saveConsultationWorkspace,);
...
router.post('/:sessionId/micro-goals/:microGoalId/evidence',upload.single('evidence_file'),studySessionController.addMicroGoalEvidence,);
router.post('/:sessionId/micro-goals/:microGoalId/work-check',upload.memoryWorkCheck.single('evidence_file'),studySessionController.checkMicroGoalWork,);
router.get('/:sessionId/micro-goals/:microGoalId/work-checks',studySessionController.getMicroGoalWorkChecks,);
router.patch('/:sessionId/micro-goals/:microGoalId/progress',studySessionController.updateMicroGoalProgress,);
